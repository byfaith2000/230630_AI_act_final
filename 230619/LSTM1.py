...
class L:
   ...
   def show_dataset_infos(self, y, x1 = 'Year', x2 = 'Month', x3 = 'Day', x4 = 'Hour', x5 = 'Year', h5 = 'Month'):
       ...
       sns.barplot(x=x1, y=y, data=self.dataset.groupby(x1)[y].mean().rest_index(), palette='Paired')
   ...
   def create_train_dataset(self):
       ...
       self.x_train, self.x_valid, self_train, self.y_valid = train_test_split(self.train_feature, self.train_label, test_size=0.2)
